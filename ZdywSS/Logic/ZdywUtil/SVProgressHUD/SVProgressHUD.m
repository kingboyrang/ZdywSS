...
- (void)setStatus:(NSString *)string {
    ...
    //计算内容的大小
    CGSize aSize = [string sizeWithFont:self.stringLabel.font constrainedToSize:CGSizeMake(280, 100)];
    
	CGFloat stringWidth = aSize.width + 28;
	...
	_hudView.bounds = CGRectMake(0, 0, hudWidth, 76 + aSize.height);
	...
	self.stringLabel.frame = CGRectMake(0, 66, CGRectGetWidth(_hudView.bounds), aSize.height);
